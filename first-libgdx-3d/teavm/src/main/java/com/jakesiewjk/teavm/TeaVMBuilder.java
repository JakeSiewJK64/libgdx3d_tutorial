...
public class TeaVMBuilder {
    public static void main(String[] args) throws IOException {
        ...
        // teaBuildConfiguration.additionalAssetsClasspathFiles.add("com/jakesiewjk/asset.extension");

        // Register any classes or packages that require reflection here:
        // TeaReflectionSupplier.addReflectionClass("com.jakesiewjk.reflect");
